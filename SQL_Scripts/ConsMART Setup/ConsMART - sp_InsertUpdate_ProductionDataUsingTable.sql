Create Procedure sp_InsertUpdate_ProductionDataUsingTable
						@data as dbo.ProductionDataType ReadOnly 
As
Begin

	Merge ProductionData d
	Using @data data on
				data.Operation				= d.Operation				
			And data.ProdMonth				= d.ProdMonth				
			And data.CalendarDate			= d.CalendarDate			
			...
			And data.ShiftDay				= d.ShiftDay				
			And data.WorkingDay				= d.WorkingDay				
