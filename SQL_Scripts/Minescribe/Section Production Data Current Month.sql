SELECT MOName, Calendardate, SUM(PlanDaySqm) PlanDaySqm, SUM(BookDaySqm) BookDaySqm, SUM(PlanDayAdv) PlanDayAdv, SUM(BookDayAdv) BookDayAdv
FROM (
...
GROUP BY MOName, Calendardate
ORDER BY MOName, Calendardate