...
namespace Mineware.Systems.Production.SysAdminScreens.OCRScheduling
{
    public partial class ucOCRSchedulingMain : Mineware.Systems.Global.ucBaseUserControl
    {
        ...
        public Mineware.Systems.Planning.PrePlanning.PlanningDefaults PlanningClass;
        ...
        private void timeEdit1_EditValueChanged(object sender, EventArgs e)
        {
            try
            {
            DateTime i = (DateTime)editProdmonth.EditValue;
            MonthTxt.Value = long.Parse(i.ToString("yyyyMM"));
                //MonthTxt.Value =  editProdmonth.EditValue
            }
            catch { }
