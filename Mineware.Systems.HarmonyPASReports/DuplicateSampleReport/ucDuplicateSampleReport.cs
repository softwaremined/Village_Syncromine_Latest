...
{
    public partial class ucDuplicateSampleReport : Mineware.Systems.Global.ReportsControls.ucReportSettingsControl
    {
        private Thread theReportThread;
        string theSystemDBTag = "DBHARMONYPAS";
        private clsDuplicateSampleReportSettings reportSettings = new clsDuplicateSampleReportSettings();
        ...
        public ucDuplicateSampleReport()
        {
            InitializeComponent();
