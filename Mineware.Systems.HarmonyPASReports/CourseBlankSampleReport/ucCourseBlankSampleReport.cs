...
{
    public partial class ucCourseBlankSampleReport : Mineware.Systems.Global.ReportsControls.ucReportSettingsControl
    {
        private Thread theReportThread;
        string theSystemDBTag = "DBHARMONYPAS";
        private clsCourseBlankSampleReportSettings reportSettings = new clsCourseBlankSampleReportSettings();
        ...
        public ucCourseBlankSampleReport()
        {
            InitializeComponent();
        ...
        private void ucCourseBlankSampleReport_Load(object sender, EventArgs e)
        {
            ...
            LoadShaft();
            pgCourseBlankReport.SelectedObject = reportSettings;
        }
        ...
        private void createReport(Object theReportSettings)
        {
                ...
                try
                {
                    ...
                    clsCourseBlankSampleReportSettings currentReportSettings = theReportSettings as clsCourseBlankSampleReportSettings;
                    string designerFile = TGlobalItems.ReportsFolder + "\\CourseBlankSampleData.Xlsx";
                    ...
                    _courseBlankData.SqlStatement = "sp_CourseBlankDataReport";
                    _courseBlankData.queryExecutionType = MWDataManager.ExecutionType.StoreProcedure;
                    _courseBlankData.ResultsTableName = "CourseBlankSampleData";
